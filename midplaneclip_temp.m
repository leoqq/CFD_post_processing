...
Y=M(:,2)*1000;
Z=M(:,3)*1000;
vari=M(:,5); %variables of interest
...
filename1='800K_temp_1.2ms.mat';
save(filename1,'Xq','Rq','tempq');
...
% figure
% hold on
% [cs,hc]=contourf(Xq,Rq,tempq,[550:20:2400]); %,[0:1e-4:5e-3]
% colormap('jet')
% %colorbar;
% caxis([550 2400])
% %txt = '0.70 ms';
...
% print('TKE_055_temp_08ms', '-dpng', '-r600')
